...
export default function Loader() {
  ...
  return (
    <div className="h-full w-full backdrop-blur-md z-100 flex items-center justify-center text-teal-700">
      <div className="loader-container px-3 py-5 bg-teal-100 shadow-2xl rounded-3xl w-72 h-63 lg:w-81 lg:h-72  mx-auto">
        {lang ? (
          ...
          <h1 className="w-fit lg:mt-5 font-lex text-center mx-auto  text-md font-bold lg:text3xl">
            Your inputs are being evaluated..
          </h1>
        )}
