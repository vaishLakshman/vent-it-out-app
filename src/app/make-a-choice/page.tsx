...
export default function MakeAChoice() {
  ...
  return (
    <div className="relative h-screen bg-teal-100 flex items-center justify-center  text-teal-700">
      <div>
        {lang ? (
          <div className="w-fit font-manj lg:w-3/5 mx-auto px-5 lg:px-3 lg:mb-10 h-72 lg:h-fit text-center">
            <h1 className="w-fit mx-auto mb-5 lg:mb-10 text-md font-bold lg:text-3xl">
              ഹൃദയം തുറന്നപ്പോൾ കുറച്ചൊക്കെ ആശ്വാസം കിട്ടിയെന്നു കരുതുന്നു.
            </h1>
            <h3 className="w-fit mx-auto mb-3 text-sm font-light lg:mb-5 lg:text-md font-bold lg:text-2xl">
